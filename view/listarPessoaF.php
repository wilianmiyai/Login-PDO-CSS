...
<html>
    ...
    <body>
        <header class="header-container">
            <nav class="top-nav">
                <h2 class="logo nav-color">Lista de Pessoa Física</h2>
                <ul class="main-nav">
        ...
        <table class="responsive-table">
            <thead>
                <tr>
                    <th>id</th><th>Nome</th><th>E-mail</th><th>CPF</th><th>Função</th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <td class="remove-item">
                            ...
                            <form action="../controller/deletarPessoaF.php" method="POST">
                                ...
                                <input type="submit" name="delete" value="deletar" style="
                                       float: left;
                                       "/>
                                <button type="button" onclick="location.href = 'cadPessoaF.php'" style="
                                        float: left;
                                        ">Voltar</button>
                            </form>
                        </td>
